...
<div class="containerS">
    <div class="container" style="padding-top: 150px; padding-bottom: 150px; height: 80vh;">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                ...
                                <form action="{{ route('cart.remove') }}" method="POST">
                                    {{ csrf_field() }}
                                    <input type="hidden" value="{{ $item->id }}" id="id" name="id">
                                    <button class="btn btn-danger btn-sm" style="margin-right: 10px;"><i class="fa fa-trash-o"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
